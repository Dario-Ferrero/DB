...
-- Votazione() 
insert into Votazione values ('riccardo.cunico@gmail.it', 'Modern family', 2009, 1);
insert into Votazione values ('riccardo.cunico@gmail.it', 'Black Mirror', 2013, 3);
insert into Votazione values ('marco.ricco@gmail.it', 'Modern family', 2009, 5);
insert into Votazione values ('patriza.cai@outlook.it', 'Modern family', 2009, 5);
insert into Votazione values ('patriza.cai@outlook.it', 'Beautifull woman', 2020, 2);
insert into Votazione values ('patriza.cai@outlook.it', 'Jojo Rabbit', 2020, 5);
